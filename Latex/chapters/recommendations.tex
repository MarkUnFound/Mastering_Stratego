...
These results establish that the MARQ architecture is not a speculative assembly of techniques. Each component addresses a specific failure mode of the baseline, and the empirical gains match the theoretical predictions from distributional RL, attention-based sequence modeling, and learned exploration. The following sections present the individual component contributions, the broader contributions to reinforcement learning methodology, and the remaining limitations.
...
The contributions below are contributions to reinforcement learning systems engineering. Stratego is the test domain, but the techniques are not domain-specific and apply to other partially observable or adversarial settings.
