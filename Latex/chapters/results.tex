...
During Phase 1 (Full Observability), the agent demonstrated rapid acquisition of basic game mechanics. Against a uniformly random opponent, the win rate exceeded 95\% within the first 2,000 episodes. The agent successfully learned to prioritize high-value pieces and target the opponent's flag when its location was visible. As part of a PBS ablation study, the system's performance is being evaluated without explicit belief tracking to determine the impact on learning stability and strategic depth.
