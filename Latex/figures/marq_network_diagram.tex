...
\node[inputbox, below=0.5cm of board, label=below:{\footnotesize AAREN Embeddings}] (pbs) {
    \begin{tabular}{c}
    \textbf{64 ch}\\
    Learned
    \end{tabular}
...
% Combine into 79-channel input
\node[rectangle, draw=convblue, fill=convblue!20, minimum width=1.5cm, minimum height=4cm, 
      right=1cm of $(board)!0.5!(pbs)$, rounded corners=3pt, label=above:{\footnotesize 79 Channels}] (input27) {};
